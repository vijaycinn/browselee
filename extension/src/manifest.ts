...
export default defineManifest({
  ...
  content_security_policy: {
    extension_pages:
      "script-src 'self'; object-src 'self'; connect-src 'self' https://*.services.ai.azure.com https://*.azure-api.net https://*.realtimeapi-preview.ai.azure.com wss://*.realtimeapi-preview.ai.azure.com https://localhost:* http://localhost:*",
  },
});
